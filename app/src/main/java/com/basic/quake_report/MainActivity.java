...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Parse JSON Response to ArrayList of type Earthquake.
        ArrayList<Earthquake> earthquakes = JSONUtils.getEarthquakes(SAMPLE_JSON_RESPONSE);

        // Link LayoutManager to RecyclerView.
        binding.recyclerEarthquake.setLayoutManager(new LinearLayoutManager(this));

        // Optimise RecyclerView.
        binding.recyclerEarthquake.setHasFixedSize(true);

        // Link Adapter to RecyclerView.
        binding.recyclerEarthquake.setAdapter(new EarthquakeAdapter(earthquakes,
                this));
    }
